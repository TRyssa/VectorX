...
/**
 * QuickTemplate class for VectorX skin
 * @ingroup Skins
 */
class VectorXTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		if ( $this->config->get( 'VectorXUseIconWatch' ) ) {
	...
	protected function renderNavigation( $elements ) {
		...
		foreach ( $elements as $name => $element ) {
			switch ( $element ) {
				case 'NAMESPACES':
					?>
					<div id="p-namespaces" role="navigation" class="vectorxTabs<?php
				...
				case 'VARIANTS':
					?>
					<div id="p-variants" role="navigation" class="vectorxMenu<?php
				...
				case 'VIEWS':
					?>
					<div id="p-views" role="navigation" class="vectorxTabs<?php
				...
				case 'ACTIONS':
					?>
					<div id="p-cactions" role="navigation" class="vectorxMenu<?php
					if ( count( $this->data['action_urls'] ) == 0 ) {
						echo ' emptyPortlet';
					}
					?>" aria-labelledby="p-cactions-label">
						<h3 id="p-cactions-label"><span><?php
							$this->msg( 'vectorx-more-actions' )
						?></span><a href="#"></a></h3>
				...
				case 'SEARCH':
					...
					<div id="p-search" role="search">
						...
						<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
							<div<?php echo $this->config->get( 'VectorXUseSimpleSearch' ) ? ' id="simpleSearch"' : '' ?>>
							<?php
